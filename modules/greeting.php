    ...
    <div class="col-lg">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-ticket fa-2x"></i>&nbsp;&nbsp; Greeting System</h3>
            </div>
			  <div class="panel-body">
			    <form action="" method="post">
				<button  class="btn btn-sm btn-default"  name="message2" value="!greeting toggle ">Auto-Greeting on/off</button>
				</form>
				</div>
            <div class="panel-body">
