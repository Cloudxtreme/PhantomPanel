        ...
        <div class="container">
            <div class="col-lg">
                <div class="panel panel-primary">
					...
					<h3 class="panel-title" style="height: 20px;"><i class="fa fa-pencil-square-o" style="float:left;padding-top: 3px;">&nbsp;&nbsp; </i>
						<div id="title" style="float:left;">Title: <span style="color:#a68ed2;" id="stream_title"></span></div>
						<div id="game" style="float:right;">Game: <span  style="color:#a68ed2;" id="stream_game"></span></div>
					</h3>
                    </div>
